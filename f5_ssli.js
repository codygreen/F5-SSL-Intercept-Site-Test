...
exports.httpsReq = function(hostname, port, suites, ca_bundle, callback) {
	...
	req.on('error', function(e) {
		if (e.message == "unable to get issuer certificate" || e.message.includes("unable to get local issuer certificate")) {
...
exports.testCA = function(hostname, port, cipherSuite, bundle, callback) {
	...
	exports.httpsReq(hostname, port, cipherSuite, bundle, function(err, res) {
		callback(err, res);
	});
...
exports.testCiphers = function(hostname, port, cipherSuite, callback) {
	...
	exports.httpsReq(hostname, port, cipherSuite, null, function(err, res) {
		callback(err, res);
	});
